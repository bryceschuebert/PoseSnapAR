...
#ifndef _JT_Writer_HeaderFile
#define _JT_Writer_HeaderFile
...
class JT_Writer : public Base_Writer
{
public:

    __CADEX_EXPORT JT_Writer();

    __CADEX_EXPORT const JT_WriterParameters& Parameters() const;

    __CADEX_EXPORT JT_WriterParameters& Parameters();
};
