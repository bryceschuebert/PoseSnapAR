...
#ifndef _ACIS_Writer_HeaderFile
#define _ACIS_Writer_HeaderFile
...
class ACIS_Writer : public Base_Writer
{
public:

    __CADEX_EXPORT ACIS_Writer();

    __CADEX_EXPORT const ACIS_WriterParameters& Parameters() const;

    __CADEX_EXPORT ACIS_WriterParameters& Parameters();
};
