...
#ifndef _Rhino_Writer_HeaderFile
#define _Rhino_Writer_HeaderFile
...
class Rhino_Writer : public Base_Writer
{
public:

    //! Constructor.
    __CADEX_EXPORT Rhino_Writer();

    //! Returns parameters.
    __CADEX_EXPORT const Rhino_WriterParameters& Parameters() const;

    //! Returns parameters.
    __CADEX_EXPORT Rhino_WriterParameters& Parameters();
};
