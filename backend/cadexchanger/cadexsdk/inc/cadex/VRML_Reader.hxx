...
#ifndef _VRML_Reader_HeaderFile
#define _VRML_Reader_HeaderFile
...
class VRML_Reader: public Base_Reader
{
public:

    __CADEX_EXPORT VRML_Reader();

    //! Returns parameters.
    __CADEX_EXPORT const VRML_ReaderParameters& Parameters() const;

    //! Returns parameters.
    __CADEX_EXPORT VRML_ReaderParameters& Parameters();
};
